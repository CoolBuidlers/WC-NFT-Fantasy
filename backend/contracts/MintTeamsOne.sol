...
contract MintTeamsOne is ERC1155, Ownable {
   event Mint(address account, uint indexed tokenId, uint256 indexed level, bytes teamName);
   ...
   modifier afterEvent {
    ...
    function setMintTeamOneAddress(address _mintTeamsTwoAddress) public {
      require(msg.sender == setAddress, "USER_CANT_CALL_FUNCTION");
    ...
    function setGuessingGameAddress(address _guessingGameAddress) external onlyOwner {
