...
contract FetchTeamsFour is Ownable {
    bytes thirteenthPlaceTeam = abi.encode("France");
    bytes fourteenthPlaceTeam = abi.encode("Australia");
    bytes fifteenthPlaceTeam = abi.encode("Denmark");
    bytes sixteenthPlaceTeam = abi.encode("Tunisia");
