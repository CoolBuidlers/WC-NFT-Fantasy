...
contract FetchTeamsThree is Ownable {
    bytes ninthPlaceTeam = abi.encode("Argentina");
    bytes tenthPlaceTeam = abi.encode("Saudi Arabia");
    bytes eleventhPlaceTeam = abi.encode("Mexico");
    bytes twelfthPlaceTeam = abi.encode("Poland");
