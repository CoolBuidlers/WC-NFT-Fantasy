...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    let smartContract = Address.fromString(
      "0x0000000000000000000000000000000000000001"
    )
    let predictor = Address.fromString(
      "0x0000000000000000000000000000000000000001"
    )
    let newAllPredictorsEvent = createAllPredictorsEvent(
      smartContract,
      predictor
    )
    handleAllPredictors(newAllPredictorsEvent)
  })
