...
import { QUIZ_GAME_CONTRACT_ABI, QUIZ_GAME_CONTRACT_ADDRESS } from './Constants/Index';
...
const AddQuestions = () => {
    ...
    const addQuestion = async (val: any): Promise <void> => {
        if(val.question && val.optionOne && val.optionTwo && val.optionThree && val.optionFour && val.answer) {
